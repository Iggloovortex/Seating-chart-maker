...
const SYMBOL_MARKUP = {
  'ic-desktop':
    '<rect x="7" y="2.5" width="10" height="19" rx="1.2" fill="none" stroke="COLOR" stroke-width="1.6"/>' +
    '<path d="M9.5 6h5M9.5 8.5h5" fill="none" stroke="COLOR" stroke-width="1.6" stroke-linecap="round"/>' +
  ...
  'ic-monitor-double':
    '<rect x="1.5" y="5" width="9.5" height="8" rx="1" fill="none" stroke="COLOR" stroke-width="1.6"/>' +
    '<rect x="13" y="5" width="9.5" height="8" rx="1" fill="none" stroke="COLOR" stroke-width="1.6"/>' +
    '<path d="M6.25 13v3.5M3.5 18.5h5.5M17.75 13v3.5M15 18.5h5.5" fill="none" stroke="COLOR" stroke-width="1.6" stroke-linecap="round"/>',
  'ic-kvm':
    '<rect x="3" y="3.5" width="18" height="12" rx="1" fill="none" stroke="COLOR" stroke-width="1.6"/>' +
    '<circle cx="6.6" cy="7.2" r=".85" fill="COLOR"/>' +
    '<circle cx="6.6" cy="11.8" r=".85" fill="COLOR"/>' +
    '<path d="M9.2 7.2h8.2M9.2 11.8h8.2" fill="none" stroke="COLOR" stroke-width="1.6" stroke-linecap="round"/>' +
    '<path d="M9 20h6m-3-4.5V20" fill="none" stroke="COLOR" stroke-width="1.6" stroke-linecap="round"/>',
  'ic-server':
    '<rect x="3" y="4" width="18" height="6" rx="1.2" fill="none" stroke="COLOR" stroke-width="1.6"/>' +
    '<rect x="3" y="14" width="18" height="6" rx="1.2" fill="none" stroke="COLOR" stroke-width="1.6"/>' +
    '<circle cx="6.6" cy="7" r=".9" fill="COLOR"/>' +
    '<circle cx="6.6" cy="17" r=".9" fill="COLOR"/>' +
    '<path d="M10 7h7M10 17h7" fill="none" stroke="COLOR" stroke-width="1.6" stroke-linecap="round"/>',
  'ic-person':
  ...
  'ic-question':
    ...
    '<path d="M9.4 9.4a2.7 2.7 0 1 1 3.3 2.7c-.9.25-1.2.85-1.2 1.65v.35" fill="none" stroke="COLOR" stroke-width="1.6" stroke-linecap="round"/>' +
