...
const SYMBOL_MARKUP = {
  ...
  'ic-chair':
    '<path d="M17,14.77C17,15.32 16.55,15.77 16,15.77L8,15.77C7.45,15.77 7,15.32 7,14.77C7,14.22 7.45,13.77 8,13.77L16,13.77C16.55,13.77 17,14.22 17,14.77Z" fill="FILL" stroke="none"/>' +
    '<path d="M5.17,9.02C5.17,9.57 4.72,10.02 4.17,10.02L2.84,10.02C2.28,10.02 1.83,9.57 1.83,9.02C1.83,8.47 2.28,8.02 2.84,8.02L4.17,8.02C4.72,8.02 5.17,8.47 5.17,9.02Z" fill="FILL" stroke="none"/>' +
    '<ellipse cx="20.5" cy="9.02" rx="1.7" ry="1.7" fill="FILL" stroke="none"/>' +
    '<path d="M17,2.65C17.15,3.82 17.15,7.71 17,8.89C16.97,9.1 16.96,9.49 16.8,9.66C16.63,9.82 16.31,9.77 16.1,9.77C14.55,9.77 9.44,9.78 7.91,9.77C7.71,9.77 7.34,9.82 7.17,9.66C7,9.49 7.03,9.11 7,8.89C6.85,7.71 6.85,3.82 7,2.65C7.05,2.26 7.5,1.9 7.9,1.87C8.66,1.81 10.33,1.68 12,1.68C13.67,1.68 15.34,1.81 16.1,1.87C16.5,1.9 16.95,2.26 17,2.65Z" fill="FILL" stroke="none"/>' +
    '<path d="M17.93,3.98C18.09,5.2 17.93,9.29 17.93,9.29C17.93,10.11 17.27,10.77 16.46,10.77L7.54,10.77C6.73,10.77 6.07,10.11 6.07,9.29C6.07,9.29 5.92,5.2 6.07,3.98C6.16,3.25 6.45,2.47 6.98,1.97C7.52,1.45 8.48,1.02 9.32,0.9C10.61,0.73 13.47,0.73 14.76,0.9C15.58,1.02 16.48,1.45 17.01,1.97C17.54,2.47 17.84,3.24 17.93,3.98ZM16.94,4.11C16.88,3.59 16.68,3.04 16.32,2.69C15.92,2.3 15.24,1.98 14.62,1.89C13.4,1.73 10.69,1.73 9.45,1.89C8.81,1.98 8.08,2.3 7.67,2.69C7.3,3.04 7.12,3.59 7.06,4.11C6.91,5.29 7.07,9.25 7.07,9.25L7.07,9.29C7.07,9.55 7.28,9.77 7.54,9.77L16.46,9.77C16.72,9.77 16.93,9.55 16.93,9.29L16.93,9.25C16.93,9.25 17.09,5.29 16.94,4.11Z" fill="COLOR" fill-rule="evenodd"/>' +
    '<path d="M23,9.02C23,9.99 22.2,10.77 21.23,10.77L19.77,10.77C18.8,10.77 18,9.99 18,9.02C18,8.05 18.8,7.27 19.77,7.27L21.23,7.27C22.2,7.27 23,8.05 23,9.02ZM22.17,9.02C22.17,8.51 21.74,8.1 21.23,8.1L19.77,8.1C19.26,8.1 18.83,8.51 18.83,9.02C18.83,9.53 19.26,9.94 19.77,9.94L21.23,9.94C21.74,9.94 22.17,9.53 22.17,9.02Z" fill="COLOR" fill-rule="evenodd"/>' +
    '<path d="M6,9.02C6,9.99 5.21,10.77 4.23,10.77L2.77,10.77C1.8,10.77 1,9.99 1,9.02C1,8.05 1.8,7.27 2.77,7.27L4.23,7.27C5.21,7.27 6,8.05 6,9.02ZM5.17,9.02C5.17,8.51 4.74,8.1 4.23,8.1L2.77,8.1C2.26,8.1 1.83,8.51 1.83,9.02C1.83,9.53 2.26,9.94 2.77,9.94L4.23,9.94C4.74,9.94 5.17,9.53 5.17,9.02Z" fill="COLOR" fill-rule="evenodd"/>' +
    '<path d="M14.5,9.77L14.5,13.77L9.5,13.77L9.5,9.77L14.5,9.77ZM13.5,10.77L10.5,10.77L10.5,12.77L13.5,12.77L13.5,10.77Z" fill="COLOR" fill-rule="evenodd"/>' +
    '<path d="M18,14.77C18,15.87 17.11,16.77 16,16.77L8,16.77C6.9,16.77 6,15.87 6,14.77C6,13.67 6.9,12.77 8,12.77L16,12.77C17.11,12.77 18,13.67 18,14.77ZM17,14.77C17,14.22 16.55,13.77 16,13.77L8,13.77C7.45,13.77 7,14.22 7,14.77C7,15.32 7.45,15.77 8,15.77L16,15.77C16.55,15.77 17,15.32 17,14.77Z" fill="COLOR" fill-rule="evenodd"/>' +
    '<path d="M13.56,16.52L12.94,19.27C12.94,19.69 13.22,18.77 12.81,18.77L11.19,18.77C10.78,18.77 10.94,19.69 10.94,19.27L10.44,16.52C10.44,16.11 10.78,15.77 11.19,15.77L12.81,15.77C13.22,15.77 13.56,16.11 13.56,16.52ZM11.44,16.77L11.69,18.77L12.26,18.77L12.56,16.77L11.44,16.77Z" fill="COLOR" fill-rule="evenodd"/>' +
    '<path d="M3.5,10.77C3.67,10.93 4,11.26 4,11.77C4,12.27 4,13.24 4,13.77C4,14.22 4.63,14.77 5,14.77C5.36,14.77 6,14.77 6,14.77" fill="none" stroke="COLOR" stroke-width="0.98" stroke-linecap="round"/>' +
    '<path d="M20.5,10.77C20.34,10.93 20,11.26 20,11.77C20,12.27 20,13.24 20,13.77C20,14.22 19.37,14.77 19,14.77C18.64,14.77 18,14.77 18,14.77" fill="none" stroke="COLOR" stroke-width="0.98" stroke-linecap="round"/>' +
    '<path d="M7,19.77C7,19.77 8.33,19.77 9,19.77C9.68,19.77 12,18.77 12,18.77C12,18.77 14.33,19.77 15,19.77C15.67,19.78 17,19.77 17,19.77" fill="none" stroke="COLOR" stroke-width="1" stroke-linecap="round"/>' +
    '<path d="M7,19.27C8.11,19.27 9,20.16 9,21.25C9,22.35 8.11,23.23 7,23.23C5.9,23.23 5,22.35 5,21.25C5,20.16 5.9,19.27 7,19.27ZM7,20.27C6.45,20.27 6,20.71 6,21.25C6,21.8 6.45,22.23 7,22.23C7.55,22.23 8,21.8 8,21.25C8,20.71 7.55,20.27 7,20.27Z" fill="COLOR" fill-rule="evenodd"/>' +
    '<path d="M17,19.27C18.11,19.27 19,20.16 19,21.25C19,22.35 18.11,23.23 17,23.23C15.9,23.23 15,22.35 15,21.25C15,20.16 15.9,19.27 17,19.27ZM17,20.27C16.45,20.27 16,20.71 16,21.25C16,21.8 16.45,22.23 17,22.23C17.55,22.23 18,21.8 18,21.25C18,20.71 17.55,20.27 17,20.27Z" fill="COLOR" fill-rule="evenodd"/>' +
    '<path d="M10,5.77L14,5.77" fill="none" stroke="COLOR" stroke-width="1.18" stroke-linecap="round"/>' +
    '<path d="M9,3.77L15,3.77" fill="none" stroke="COLOR" stroke-width="1" stroke-linecap="round"/>' +
    '<path d="M9,7.77L15,7.77" fill="none" stroke="COLOR" stroke-width="1" stroke-linecap="round"/>',
  'ic-question':
